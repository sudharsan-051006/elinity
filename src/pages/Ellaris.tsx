...
useEffect(() => {
  ...
  const coreCard1 = useScrollReveal();
  const coreCard2 = useScrollReveal();
  const coreCard3 = useScrollReveal();
  const coreCard4 = useScrollReveal();
  const coreCard5 = useScrollReveal();
