  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* meta info */}
        <div style={{ opacity: 0.85, lineHeight: 1.9, fontSize: 16 }}>
          <div>📍 Location: New York City (remote to start, NYC-based)</div>
          <div>🕒 Type: Full-Time</div>
          <div>💰 Salary: $120K–$180K + founding equity</div>
          <div>🚀 Start Date: ~April 15th</div>
          <div>🏠 Home: elinity.ai</div>
        </div>
      </motion.div>
        {/* SECTION CARDS */}
        {[
